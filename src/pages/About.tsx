    ...
    <div className="bg-futi-white py-16 md:py-24">
      <div className="container mx-auto px-4">
        <h1 className="text-4xl md:text-5xl font-bold text-center text-futi-night-blue mb-16">
          À propos de <span className="text-futi-orange">FutiCoop</span>
        </h1>

        {/* Mission Section */}
        <section className="mb-16">
          <Card className="bg-futi-night-blue text-futi-white shadow-lg border-futi-orange/20">
            <CardHeader className="flex flex-row items-center space-x-4">
              <Target className="h-10 w-10 text-futi-orange" />
        ...
        {/* Vision Section */}
        <section className="mb-16">
          <Card className="bg-futi-white text-futi-night-blue shadow-lg border-futi-orange/20">
            <CardHeader className="flex flex-row items-center space-x-4">
              <Eye className="h-10 w-10 text-futi-orange" />
        ...
        <section className="mb-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <Card className="text-center p-6 shadow-md border-futi-orange/20">
              <Handshake className="h-12 w-12 text-futi-orange" />
            ...
            <Card className="text-center p-6 shadow-md border-futi-orange/20">
              <ShieldCheck className="h-12 w-12 text-futi-orange" />
        ...
        <section>
          <Card className="bg-futi-night-blue text-futi-white shadow-lg border-futi-orange/20">
            <CardHeader className="flex flex-row items-center space-x-4">
              <History className="h-10 w-10 text-futi-orange" />
