    ...
    <div className="bg-futi-white py-16 md:py-24">
      <div className="container mx-auto px-4">
        <h1 className="text-4xl md:text-5xl font-bold text-center text-futi-night-blue mb-16">
          Contactez <span className="text-futi-gold">FutiCoop</span>
        </h1>

        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          {/* Contact Form */}
          <Card className="shadow-lg border-futi-gold/20">
            <CardHeader>
            ...
            <CardContent>
              <form className="space-y-6">
                <div>
                  ...
                  <Input id="name" type="text" placeholder="Votre nom" className="mt-1 border-futi-gold/30 focus:border-futi-gold focus:ring-futi-gold" />
                </div>
                <div>
                  <Label htmlFor="email" className="text-futi-night-blue">Adresse e-mail</Label>
                  <Input id="email" type="email" placeholder="Votre email" className="mt-1 border-futi-gold/30 focus:border-futi-gold focus:ring-futi-gold" />
                </div>
                <div>
                  <Label htmlFor="subject" className="text-futi-night-blue">Sujet</Label>
                  <Input id="subject" type="text" placeholder="Sujet de votre message" className="mt-1 border-futi-gold/30 focus:border-futi-gold focus:ring-futi-gold" />
                </div>
                <div>
                  <Label htmlFor="message" className="text-futi-night-blue">Votre message</Label>
                  <Textarea id="message" placeholder="Écrivez votre message ici..." rows={5} className="mt-1 border-futi-gold/30 focus:border-futi-gold focus:ring-futi-gold" />
                </div>
                <Button type="submit" className="w-full bg-futi-gold text-futi-night-blue hover:bg-futi-gold/90 py-3 text-lg font-semibold">
                  Envoyer le message
                </Button>
              </form>
            </CardContent>
            ...
            <Card className="shadow-lg border-futi-gold/20">
              ...
              <CardContent className="space-y-4 text-lg text-gray-700">
                <div className="flex items-center space-x-3">
                  <MapPin className="h-6 w-6 text-futi-gold" />
                  <span>1, Avenue 24 Novembre, Gombe — Station Arianna</span>
                </div>
                <div className="flex items-center space-x-3">
                  <Phone className="h-6 w-6 text-futi-gold" />
                  <span>WhatsApp : +243 837 767 676</span>
                </div>
                <div className="flex items-center space-x-3">
                  <Mail className="h-6 w-6 text-futi-gold" />
