  ...
  return (
    <div className="bg-futi-white">
      ...
      <section className="relative bg-futi-night-blue text-futi-white py-20 md:py-32 overflow-hidden">
        <div className="container mx-auto text-center relative z-10">
          <h1 className="text-4xl md:text-6xl font-extrabold mb-6 leading-tight animate-fade-in-up">
            <span className="text-futi-gold">FutiCoop</span> : Sécurité — Rentabilité — Confiance
          </h1>
          ...
          <Link to="/contact">
            <Button className="bg-futi-gold text-futi-night-blue hover:bg-futi-gold/90 px-8 py-6 text-lg font-semibold rounded-full shadow-lg transition-all duration-300 ease-in-out transform hover:scale-105 animate-fade-in-up delay-400">
        ...
        <div className="container mx-auto text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {services.map((service, index) => (
              <Card key={index} className="bg-futi-white shadow-lg hover:shadow-xl transition-shadow duration-300 border-futi-gold/20">
      ...
      <section className="py-16 md:py-24 bg-futi-night-blue text-futi-white">
        <div className="container mx-auto text-center">
          <h2 className="text-3xl md:text-4xl font-bold text-futi-gold mb-12">Pourquoi choisir FutiCoop ?</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="p-6 bg-futi-white text-futi-night-blue rounded-lg shadow-lg hover:shadow-xl transition-shadow duration-300">
              <ShieldCheck className="h-10 w-10 text-futi-gold mx-auto mb-4" />
            ...
            <div className="p-6 bg-futi-white text-futi-night-blue rounded-lg shadow-lg hover:shadow-xl transition-shadow duration-300">
              <TrendingUp className="h-10 w-10 text-futi-gold mx-auto mb-4" />
            ...
            <div className="p-6 bg-futi-white text-futi-night-blue rounded-lg shadow-lg hover:shadow-xl transition-shadow duration-300">
              <Users className="h-10 w-10 text-futi-gold mx-auto mb-4" />
          ...
          <Link to="/about" className="mt-12 inline-block">
            <Button variant="outline" className="bg-transparent text-futi-gold border-futi-gold hover:bg-futi-gold hover:text-futi-night-blue px-8 py-4 text-lg rounded-full transition-all duration-300 ease-in-out">
      ...
      <section className="py-16 md:py-24 bg-futi-gold text-futi-night-blue text-center">
        <div className="container mx-auto">
          ...
          <Link to="/contact">
            <Button className="bg-futi-night-blue text-futi-gold hover:bg-futi-night-blue/90 px-8 py-6 text-lg font-semibold rounded-full shadow-lg transition-all duration-300 ease-in-out transform hover:scale-105">
