...
const serviceList = [
  ...
  {
    icon: <CalendarCheck className="h-8 w-8 text-futi-gold" />,
  ...
  {
    icon: <FileText className="h-8 w-8 text-futi-gold" />,
  ...
  {
    icon: <Wrench className="h-8 w-8 text-futi-gold" />,
  ...
  {
    icon: <ClipboardList className="h-8 w-8 text-futi-gold" />,
  ...
  {
    icon: <Gavel className="h-8 w-8 text-futi-gold" />,
  ...
  {
    icon: <BellRing className="h-8 w-8 text-futi-gold" />,
    ...
    <div className="bg-futi-white py-16 md:py-24">
      <div className="container mx-auto px-4">
        <h1 className="text-4xl md:text-5xl font-bold text-center text-futi-night-blue mb-16">
          Nos <span className="text-futi-gold">Services</span>
        </h1>
