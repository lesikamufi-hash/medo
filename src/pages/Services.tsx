...
const serviceList = [
  ...
  {
    icon: <CalendarCheck className="h-8 w-8 text-futi-accent" />,
  ...
  {
    icon: <FileText className="h-8 w-8 text-futi-accent" />,
  ...
  {
    icon: <Wrench className="h-8 w-8 text-futi-accent" />,
  ...
  {
    icon: <ClipboardList className="h-8 w-8 text-futi-accent" />,
  ...
  {
    icon: <Gavel className="h-8 w-8 text-futi-accent" />,
  ...
  {
    icon: <BellRing className="h-8 w-8 text-futi-accent" />,
