      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        <Card className="shadow-md border-futi-gold/20">
          ...
          <CardContent>
            ...
            <Button variant="outline" className="text-futi-night-blue border-futi-gold hover:bg-futi-gold/10">Voir le carnet complet</Button>
          </CardContent>
        </Card>
        <Card className="shadow-md border-futi-gold/20">
          <CardHeader>
          ...
          <CardContent>
            ...
            <Button variant="outline" className="text-futi-night-blue border-futi-gold hover:bg-futi-gold/10">Consulter le planning</Button>
          </CardContent>
        </Card>
      </div>
