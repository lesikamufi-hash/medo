      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        <Card className="shadow-md border-futi-orange/20">
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            ...
            <DollarSign className="h-4 w-4 text-futi-orange" />
          </CardHeader>
          <CardContent>
        ...
        <Card className="shadow-md border-futi-orange/20">
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            ...
            <Car className="h-4 w-4 text-futi-orange" />
          </CardHeader>
          <CardContent>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        <Card className="shadow-md border-futi-orange/20">
          ...
          <CardContent>
            ...
            <Button variant="outline" className="text-futi-night-blue border-futi-orange hover:bg-futi-orange/10">Voir le carnet complet</Button>
          </CardContent>
        </Card>
        <Card className="shadow-md border-futi-orange/20">
          <CardHeader>
          ...
          <CardContent>
            ...
            <Button variant="outline" className="text-futi-night-blue border-futi-orange hover:bg-futi-orange/10">Consulter le planning</Button>
          </CardContent>
        </Card>
      </div>
