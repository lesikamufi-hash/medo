        ...
        <CardContent className="space-y-4">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
              ...
              <Select>
                <SelectTrigger id="report-type" className="w-full border-futi-gold/30 focus:ring-futi-gold focus:border-futi-gold">
            ...
            <div>
              ...
              <Select>
                <SelectTrigger id="report-period" className="w-full border-futi-gold/30 focus:ring-futi-gold focus:border-futi-gold">
          ...
          <Button className="w-full bg-futi-gold text-futi-night-blue hover:bg-futi-gold/90">
      ...
      <Card className="shadow-md border-futi-gold/20">
        ...
        <CardContent className="space-y-3">
          <div className="flex items-center justify-between p-3 border rounded-md bg-gray-50">
            ...
            <Button variant="outline" size="sm" className="text-futi-night-blue border-futi-gold hover:bg-futi-gold/10">
              Télécharger
            </Button>
          </div>
          <div className="flex items-center justify-between p-3 border rounded-md bg-gray-50">
