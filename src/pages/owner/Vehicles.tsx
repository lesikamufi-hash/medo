...
const vehicles = [
  { id: 'v001', brand: 'Toyota', model: 'Corolla', plate: 'ABC-123', status: 'Actif', entryDate: '2023-01-15' },
  { id: 'v002', brand: 'Mercedes', model: 'C-Class', plate: 'DEF-456', status: 'Actif', entryDate: '2023-03-20' },
  { id: 'v003', brand: 'Hyundai', model: 'Tucson', plate: 'GHI-789', status: 'En maintenance', entryDate: '2023-06-10' },
];
